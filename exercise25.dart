...
void main() {
  ...
  while (true) {
    ...
    if(word.indexOf(cmd.toUpperCase()) != -1) {
      wordWish = replaceLetter(word.toUpperCase(), wordWish, cmd.toUpperCase());
      print("$wordWish");    
      if(wordWish == word) {
        print("You Win");
        print("Do you want continue? Y o N");
        String res = stdin.readLineSync() as String;
      ...
      attempt += 1;
      print("You have $attempt incorrect guesses left");
      print("$wordWish");
      if(attempt == 6) {
        print("You Lose");
        print("Do you want continue? Y o N");
